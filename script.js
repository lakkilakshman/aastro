...
const translations = {
    en: {
        ...
        'service-1-title': 'Scan Mobile Numbers',
        ...
        'service-2-title': 'Mobile Number Suggestion',
        'service-2-desc': 'Optimize your name according to numerological principles to attract positive energy and success.',
        'service-3-title': 'Kundli as Numerology',
        'service-3-desc': 'Get personalized guidance on Kundli as Numerology and professional growth through astrological insights.',
        'service-4-title': 'One-to-One Consultation',
        'service-4-desc': 'Personalized one-to-one astrology consultation for accurate guidance in career, relationships, health, and more.',
    ...
    hi: {
        ...
        'service-1-title': 'मोबाइल नंबर स्कैन करें',
        'service-1-desc': 'अपनी संख्या विज्ञान की कंपनों के साथ संरेखित करने वाला सही मोबाइल नंबर खोजें जो भाग्य और समृद्धि बढ़ाए।',
        'service-2-title': 'मोबाइल नंबर सुझाव',
        'service-2-desc': 'सकारात्मक ऊर्जा और सफलता आकर्षित करने के लिए अंक ज्योतिष के सिद्धांतों के अनुसार अपना नाम अनुकूलित करें।',
        'service-3-title': 'अंक ज्योतिष के रूप में कुंडली',
        'service-3-desc': 'ज्योतिषीय अंतर्दृष्टि के माध्यम से कुंडली, अंक ज्योतिष और व्यावसायिक विकास पर व्यक्तिगत मार्गदर्शन प्राप्त करें।',
        'service-4-title': 'एक-से-एक परामर्श',
        'service-4-desc': 'करियर, रिश्तों, स्वास्थ्य आदि में सटीक मार्गदर्शन के लिए व्यक्तिगत एक-से-एक ज्योतिष परामर्श।',
